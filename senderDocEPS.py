...
def get_report1(cassa):
	msg = "<createReport><fiscalInformation tillId =\""+str(cassa)+"\"  /></createReport>"
	soaptoken = "<?xml version=\"1.0\" encoding=\"utf-8\"?><soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body>"+msg+"</soapenv:Body></soapenv:Envelope>"
	reply = send_post(soaptoken)
	print reply

def get_report2(cassa,znum):
	msg = "<createReport><zReport tillId =\""+str(cassa)+"\" zRepNumber=\""+str(znum)+"\" /></createReport>"
	soaptoken = "<?xml version=\"1.0\" encoding=\"utf-8\"?><soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body>"+msg+"</soapenv:Body></soapenv:Envelope>"
	reply = send_post(soaptoken)
	print reply
...
def get_report3():
	msg = "<createReport><firmwareVersion /></createReport>"
	soaptoken = "<?xml version=\"1.0\" encoding=\"utf-8\"?><soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body>"+msg+"</soapenv:Body></soapenv:Envelope>"
	reply = send_post(soaptoken)
	print reply
...
def get_report4():
	msg = "<printerCommand><directIO command=\"3013\" data=\"01260619260619\" timeout=\"120000\" /></printerCommand>"
	soaptoken = "<?xml version=\"1.0\" encoding=\"utf-8\"?><soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body>"+msg+"</soapenv:Body></soapenv:Envelope>"
	reply = send_post2(soaptoken)
	print reply

chiusuraRT = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?><SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><printerFiscalReport><printZReport operator=\"1\" timeout=\"600000\" /></printerFiscalReport></SOAP-ENV:Body></SOAP-ENV:Envelope>"

#send_post_apparato(soap)
#send_post(chiusuraRT)
#exit(0)
...
chiusaracassa = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?><SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><createDailyClosure><till tillId=\"AAAA0003\" /></createDailyClosure></SOAP-ENV:Body></SOAP-ENV:Envelope>"

#send_post(chiusaracassa)

#send_post(chiusuraRT)

get_report1(cassa_matricola)
get_report2(cassa_matricola,19)
get_report3()
get_report4()
